...
int main(void)
{
  ...
  int sec_special_case=0;
  int min_special_case=0;
  if(sec==11) sec_special_case=1;
  if(min==11) min_special_case=1;
  /* USER CODE END 2 */
  ...
  while (1)
  {
	  ...
	  clearAllClock();
	  if(sec>11){
		  if(sec_special_case==0){
			  min++;
		  }else if(sec_special_case==1){
			  sec_special_case=0;
		  }
		  sec=0;
	  }
	  ...
	  /* SET MIN */
	  if(min>11){
		  if(min_special_case==0){
			  hour++;
		  }else if(min_special_case==1){
			  min_special_case=0;
		  }
		  min=0;
	  }
